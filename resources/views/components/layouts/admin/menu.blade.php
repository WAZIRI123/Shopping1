@props(['companies'])
<!-- it will be hidden in large screen by xl:hidden -->
...
@stack('menu_start')
<!-- those sidebar icons on most left -->
<div
    x-data="{ }"
...
<!-- what will be displayed when user click notification icon -->
...
<!--  sidebar menu after most left one-->
...
<!-- arrows in front of logo on sidebar menu -->
...
<!-- what will be displayed after clicking those arrows -->
...
<!-- rest of the default menu -->
        <div class="main-menu transform">
            {!! menu('admin') !!}
        </div>
    </nav>
<!-- what will be displayed when user click profile icon -->
...
<!-- what will be displayed when user click notification icon -->
    ...
    @endcan
<!-- what will be displayed when user click setting icon -->
...
<!-- what will be displayed when user click add icon -->
